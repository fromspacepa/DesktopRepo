...
//>>>Difference between Equal/Equality Operators used with Primitive Data Types & Non-Primitive/Reference Data Types:
		...
		//they will check/compare the values of the Primitive Data Types in Stack; to see if the values are Equal/Same OR Not Equal/Same.
...
//>>>NOTE: Never use Equality Operators to compare Non-Primitive/Reference Data Types. Because it will never give you the correct response.
		...
		String str1 = new String("test");//Here the String "str1" OR new Object is created in the Memory, and the Value "test" is assigned to it.
		String str2 = new String("test");//Here the String "str2" OR new Object is created in the Memory, and the same above^ Value "test" is assigned to it.
		...
		//because, there are both stored/saved in the different locations in the Memory.
